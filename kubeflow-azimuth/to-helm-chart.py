...
MIRRORED_IMAGES = [
    ...
    "docker.io/kserve/kserve-controller:v0.10.0",
    "docker.io/kserve/models-web-app:v0.10.0",
    "docker.io/kubeflow/training-operator:v1-5a5f92d",
    "docker.io/kubeflownotebookswg/jupyter-pytorch-cuda-full:v1.7.0",
    "docker.io/kubeflownotebookswg/jupyter-pytorch-full:v1.7.0",
    "docker.io/kubeflownotebookswg/jupyter-scipy:v1.7.0",
    "docker.io/kubeflownotebookswg/jupyter-tensorflow-cuda-full:v1.7.0",
    "docker.io/kubeflownotebookswg/jupyter-tensorflow-full:v1.7.0",
    ...
    "docker.io/tensorflow/tensorflow:2.5.1",
]
